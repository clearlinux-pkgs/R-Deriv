...
Version  : 4.2.0
Release  : 48
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/Deriv_4.2.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/Deriv_4.2.0.tar.gz
...
%setup -q -n Deriv
pushd ..
cp -a Deriv buildavx2
popd
pushd ..
cp -a Deriv buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750452883
